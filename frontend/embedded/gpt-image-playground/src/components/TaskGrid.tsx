    ...
    return (
      <div data-image-empty-state className="lingqu-empty-state mx-auto mt-8 grid max-w-lg justify-items-center rounded-[24px] border border-[rgba(33,31,28,0.14)] bg-white/70 px-6 py-14 text-center text-gray-400 shadow-[0_14px_30px_rgba(33,31,28,0.07)] backdrop-blur">
        {searchQuery || filterFavorite ? (
          ...
          <>
            <svg
              className="mb-4 h-20 w-20 rounded-[24px] border-2 border-[#211f1c] bg-[#fff5c9] p-5 text-[#211f1c] shadow-[5px_5px_0_rgba(33,31,28,0.82)]"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <p className="text-base font-black text-[#211f1c]">在下方输入提示词，第一张图就会出现在这里</p>
            <p className="mt-2 text-sm font-semibold text-gray-500">当前 Key 已由灵渠AI接入，无需重复配置。</p>
          </>
        )}
      </div>
    )
