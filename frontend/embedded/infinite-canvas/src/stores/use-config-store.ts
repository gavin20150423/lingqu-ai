...
export type VideoPricingVariant = {
    billing_unit?: string;
    resolution?: string;
    quality?: string;
    aspect_ratio?: string;
    unit_price?: string | number;
    audio_unit_price?: string | number;
    currency?: string;
};
  ...
  export type VideoModelCapability = {
    ...
    default_aspect_ratio?: string;
      ...
      pricing_variants?: VideoPricingVariant[];
    ...
    output?: {
        ...
        default_duration?: number;
        default_aspect_ratio?: string;
        durations_by_resolution?: Record<string, VideoDurationRule>;
        durations?: Array<number | string>;
...
export type ModelChannel = {
    ...
    /** Use the local image-task submit/poll protocol used by the image workshop. */
    asyncImageTasks?: boolean;
    models: ChannelModel[];
};

export type AiConfig = {
    channelMode: "remote" | "local";
    /** Connection credentials are supplied by the host application and must not be edited in the embedded UI. */
    credentialsManagedByHost?: boolean;
    baseUrl: string;
    apiKey: string;
    apiFormat: ApiCallFormat;
...
export const defaultConfig: AiConfig = {
    channelMode: "local",
    credentialsManagedByHost: false,
...
export function videoModelCapabilityOf(config: AiConfig, value: string): VideoModelCapability | undefined {
...
export function normalizeChannelModels(models: Array<string | ChannelModel> | undefined): ChannelModel[] {
    ...
    for (const item of models || []) {
        ...
        const videoCapability = typeof item === "string" ? undefined : item.videoCapability;
        result.push({ name, capability, script, ...(videoCapability ? { videoCapability } : {}) });
    }
    return result;
}
...
export function createModelChannel(channel?: Partial<ModelChannel>): ModelChannel {
    ...
    return {
        ...
        apiFormat,
        ...(channel?.asyncImageTasks ? { asyncImageTasks: true } : {}),
...
export function resolveModelRequestConfig(config: AiConfig, value: string) {
    ...
    return {
        ...
        asyncImageTasks: channel.asyncImageTasks,
    };
}
