...
export function ChannelEditorDrawer({ open, channel, managedCredentials = false, onSave, onClose }: { open: boolean; channel: ModelChannel | null; managedCredentials?: boolean; onSave: (channel: ModelChannel) => void; onClose: () => void }) {
        ...
        >
            <div className="grid gap-4 md:grid-cols-2">
                ...
                <label className="block">
                    ...
                    <Select className="w-full" value={draft.apiFormat} options={apiFormatOptions} onChange={changeApiFormat} disabled={managedCredentials} />
                </label>
