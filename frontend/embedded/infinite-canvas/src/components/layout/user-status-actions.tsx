...
export function UserStatusActions({ showConfig = true, showDocs = true, showGitHub = true, showPlugins = true, showVersion = true, variant = "default", onOpenShortcuts, onOpenPlugins }: UserStatusActionsProps) {
