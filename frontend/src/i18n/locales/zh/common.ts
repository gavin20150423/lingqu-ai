export default {
  common: {
    ...
    fileTooLargeKb: '文件过大（最大 {size} KB）',
    upload: '上传',
    remove: '移除',
    copy: '复制',
    notAvailable: '不可用',
  ...
  auth: {
    ...
    loginDescription: '进入后复制一个 Key，就能开始接入多个顶尖模型。',
    ...
    createAccount: '创建账户',
    signUpToStart: '注册后复制一个 Key，就能开始接入多个顶尖模型。',
    signUp: '注册',
    processing: '处理中...',
    continue: '继续',
    rememberMe: '记住我',
    ...
    emailDomainRegistrationLimit: '该邮箱域名已达到注册数量限制。',
