    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          customUsers: {
            title: '专属用户配置',
            description: '为指定用户设置邀请码、返利比例和结算方式。仅展示已设置过专属配置的用户。',
            addButton: '添加专属用户',
            ...
            offlineSettleAction: '线下结算清零',
            offlineSettleTitle: '确认线下结算',
            offlineSettleMessage: '确认将 {email} 当前可转返利 {amount} 清零？\n本次操作不会增加用户账户余额，冻结中和历史累计返利不受影响。\n流水理由将记录为“{reason}”。',
            offlineSettleReason: '已线下结算',
            offlineSettleConfirm: '确认结算并清零',
          ...
          modal: {
            ...
            transferDisabledLabel: '改为线下结算',
            transferDisabledHint: '开启后，用户无法将返利转入账户余额；管理员可执行线下结算清零。',
            errorBadRate: '请输入 0-100 之间的比例',
            errorEmpty: '请至少修改一项专属配置',
          },
          batchModal: {
