export default {
  xiaoVideo: {
    ...
    perSecondSuffix: '/秒',
    perRequestSuffix: '/次',
    internalCostEquivalent: '站内等价 ${price}{unit}',
    ...
    protocolCustomJSON: '自定义 JSON / REST 适配器',
    adapterConfig: '适配器配置（JSON）',
    ...
    adapterConfigHint: '路径相对 Base URL，只支持 {job_id} 和 {media_id} 占位符，不执行外部脚本或 URL。',
    baseUrl: '上游 Base URL',
    apiKey: '上游 API Key',
