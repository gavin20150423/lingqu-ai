export default {
    ...
    subscriptions: {
      ...
      planHint: '选择后将按该套餐保存有效期、日/周/月额度和权益',
      plansLoading: '正在加载套餐…',
      noPlansForGroup: '该分组暂无套餐，将按下方自定义有效期分配',
      planValidity: '有效期',
      planDaily: '日额度',
      planWeekly: '周额度',
      planMonthly: '月额度',
      planOffSale: '已下架',
      pleaseSelectPlan: '请选择具体套餐',
      planUnavailable: '所选套餐已不存在或不属于当前分组',
      failedToLoadPlans: '套餐列表加载失败，请刷新后重试',
      validityUnits: {
        day: '天',
        days: '天',
        week: '周',
