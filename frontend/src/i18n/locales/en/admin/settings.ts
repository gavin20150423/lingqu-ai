      ...
      features: {
        ...
        affiliate: {
          ...
          customUsers: {
            ...
            description: 'Set invite codes, rebate rates, and settlement modes for specific users. Only users with an override are listed.',
            ...
            offlineSettleAction: 'Settle offline',
            offlineSettleTitle: 'Confirm Offline Settlement',
            offlineSettleMessage: 'Clear {email}’s currently transferable rebate quota of {amount}?\nThis will not credit the account balance. Frozen and historical rebate totals are unchanged.\nThe ledger reason will be recorded as “{reason}”.',
            offlineSettleReason: 'Settled offline',
            offlineSettleConfirm: 'Settle and Clear',
            resetTitle: 'Reset Custom Settings',
            resetMessage: 'Reset all custom settings for {email}?\n• The exclusive rebate rate will be cleared (fall back to the global rate)\n• The invite code will be regenerated as a new system code (previously shared links will stop working)\n• Affiliate transfers to account balance will be enabled again',
          ...
          modal: {
            ...
            transferDisabledLabel: 'Use offline settlement',
            transferDisabledHint: 'When enabled, the user cannot transfer rebates to account balance. Admins can clear them after offline settlement.',
            errorBadRate: 'Please enter a number between 0 and 100',
            errorEmpty: 'Change at least one custom setting',
          },
          batchModal: {
