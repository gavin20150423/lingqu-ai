export default {
    ...
    backup: {
      ...
      imageStorage: {
        ...
        description: 'Async image tasks are always available. Results use persistent server storage by default; enable S3 here to use object storage instead. Changes apply without a restart.',
        enabled: 'Use S3 object storage',
        localFallback: 'Persistent server storage is active. Images are served from this platform address.',
    ...
    groups: {
      ...
      form: {
        ...
        autoAssignByRate: 'Auto-assign by account rate',
        autoAssignByRateHint: 'Continuously maintains matching accounts on this platform without changing manual bindings',
        autoAssignMaxRate: 'Maximum account rate',
        autoAssignMaxRateHint: 'Includes same-platform accounts at or below this rate and updates membership when rates change',
        autoAssignMaxRateRequired: 'Enter an account rate limit greater than or equal to 0',
        rpmLimit: 'Requests Per Minute (RPM)',
        rpmLimitPlaceholder: '0 = unlimited',
