export default {
    ...
    subscriptions: {
      ...
      selectPlan: 'Select a specific plan',
      groupHint: 'Only groups with subscription billing type are shown',
      planHint: 'The selected plan supplies the validity, daily/weekly/monthly quotas, and entitlements',
      plansLoading: 'Loading plans...',
      noPlansForGroup: 'This group has no plans; the custom validity below will be used',
      planValidity: 'Validity',
      planDaily: 'Daily quota',
      planWeekly: 'Weekly quota',
      planMonthly: 'Monthly quota',
      planOffSale: 'off sale',
      pleaseSelectPlan: 'Please select a specific plan',
      planUnavailable: 'The selected plan is unavailable or belongs to another group',
      failedToLoadPlans: 'Failed to load plans. Refresh and try again',
      validityUnits: {
        day: 'd',
        days: 'd',
        week: 'w',
