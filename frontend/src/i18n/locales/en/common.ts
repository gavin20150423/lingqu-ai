export default {
  common: {
    ...
    fileTooLargeKb: 'File is too large (maximum {size} KB)',
    upload: 'Upload',
    remove: 'Remove',
    copy: 'Copy',
    notAvailable: 'N/A',
  ...
  nav: {
    ...
    buySubscription: 'Subscription Plans',
    docs: 'Docs',
    myOrders: 'My Orders',
  ...
  auth: {
    ...
    loginEyebrow: 'LINGQU AI LOGIN',
    loginHeading: 'Sign in to {siteName}',
    loginDescription: 'Sign in, copy a Key, and start calling the top models.',
    signUpEyebrow: 'LINGQU AI SIGN UP',
    signIn: 'Sign In',
    ...
    signUpToStart: 'Sign up, copy a Key, and start calling the top models.',
    signUp: 'Sign up',
    processing: 'Processing...',
    continue: 'Continue',
    ...
    emailAliasNotAllowed: 'Email aliases containing +tag cannot be used for registration. Use your original email address.',
    emailSuffixNotAllowed: 'This email domain is not allowed for registration.',
    emailSuffixNotAllowedWithAllowed:
      'This email domain is not allowed. Allowed domains: {suffixes}',
    emailSuffixAllowedMore: 'and {count} more',
    emailDomainRegistrationLimit: 'This email domain has reached its registration limit.',
