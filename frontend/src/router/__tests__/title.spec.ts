...
describe('resolveDocumentTitle', () => {
  ...
  it('站点名为空时，回退默认站点名', () => {
    expect(resolveDocumentTitle('Dashboard', '')).toBe('Dashboard - 灵渠AI')
    expect(resolveDocumentTitle(undefined, '   ')).toBe('灵渠AI')
  })

  it('旧默认站点名会归一到新品牌名', () => {
    expect(resolveDocumentTitle('Dashboard', 'Sub2API')).toBe('Dashboard - 灵渠AI')
  })
