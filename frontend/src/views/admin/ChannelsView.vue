...
import { mTokToPerToken, perTokenToMTok, apiIntervalsToForm, formIntervalsToAPI, apiTimePricingToForm, formTimePricingToAPI, createDefaultTimePricingForm, findModelConflict, validateIntervals, isValidPositiveMultiplier } from '@/components/admin/channel/types'
      ...
      rules.push({
        ...
        pricing: rule.pricing
          ...
          .map(p => ({
            ...
            time_pricing: formTimePricingToAPI(p.time_pricing)
          }))
      })
    }
  }
