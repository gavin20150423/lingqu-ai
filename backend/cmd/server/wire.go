...
func provideCleanup(
	...
	xiaoVideoRuntime *service.XiaoVideoRuntime,
	...
	return func() {
		...
		parallelSteps := []cleanupStep{
			...
			{"XiaoVideoRuntime", func() error {
				if xiaoVideoRuntime != nil {
					xiaoVideoRuntime.Stop()
				}
				return nil
			}},
			...
			{"CommunityBillingService", func() error {
				communityBilling.Stop()
				return nil
			}},
