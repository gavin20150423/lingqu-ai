...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	videoObjectStoreFactory := repository.NewAliyunOSSVideoObjectStoreFactory()
	videoStorageSettingService := service.ProvideVideoStorageSettingService(settingRepository, secretEncryptor, configConfig, videoObjectStoreFactory)
	...
	xiaoVideoService := service.ProvideXiaoVideoService(videoRepository, accountRepository, openAIGatewayService, httpUpstream, apiKeyAuthCacheInvalidator, billingCacheService, configConfig, videoStorageSettingService)
