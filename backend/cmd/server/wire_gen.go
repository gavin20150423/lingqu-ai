...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountShareModeService := service.ProvideAccountShareModeService(configConfig, accountShareModeRepository, accountRepository, apiKeyRepository, userRepository, proxyRepository, openAIOAuthService, oAuthService, concurrencyService, apiKeyAuthCacheInvalidator, accountTestService, rateLimitService, billingCacheService, billingService, modelPricingResolver, settingRepository, settingService, openAIGatewayService)
	...
	accountShareModePolicyHandler := admin.NewAccountShareModePolicyHandler(accountShareModeService)
	...
	contentModerationService := service.ProvideContentModerationService(settingRepository, contentModerationRepository, contentModerationHashCache, groupRepository, userRepository, proxyRepository, apiKeyAuthCacheInvalidator, emailService, accountShareModeService)
	...
	receiptCodeStorageConfigProvider := service.NewReceiptCodeStorageConfigProvider(configConfig)
	...
	openAIGatewayHandler := handler.ProvideOpenAIGatewayHandler(openAIGatewayService, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, opsService, grokQuotaService, openAIImageAsyncTaskStore, configConfig, coordinator)
	...
	subPilotInternalHandler := handler.NewSubPilotInternalHandler(accountTestService, configConfig)
	...
	xiaoVideoService := service.NewXiaoVideoService(videoRepository, accountRepository, openAIGatewayService, httpUpstream, apiKeyAuthCacheInvalidator, billingCacheService, configConfig)
	xiaoVideoHandler := handler.NewXiaoVideoHandler(xiaoVideoService, openAIGatewayHandler)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, accountShareModeHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, conversationHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, passkeyHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, receiptCodeHandler, handlerWithdrawalHandler, handlerShopHandler, subPilotInternalHandler, modelPlazaHandler, asyncImageHandler, batchImageHandler, xiaoVideoHandler, communityHandler, idempotencyCoordinator, idempotencyCleanupService)
	...
	xiaoVideoRuntime := service.NewXiaoVideoRuntime(xiaoVideoService, configConfig)
	scheduledTestRunnerService := service.ProvideScheduledTestRunnerService(scheduledTestPlanRepository, scheduledTestService, accountTestService, rateLimitService, configConfig)
	paymentOrderExpiryService := service.ProvidePaymentOrderExpiryService(paymentService, leaderLockCache, db)
	channelMonitorRunner := service.ProvideChannelMonitorRunner(channelMonitorService, settingService)
	userPlatformQuotaUsageFlusher := service.ProvideUserPlatformQuotaUsageFlusher(configConfig, billingCache, serviceUserPlatformQuotaRepository, timingWheelService)
	v := provideCleanup(client, redisClient, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, opsService, opsIngressRejectAggregator, apiKeyService, authCacheInvalidationWorker, schedulerSnapshotService, tokenRefreshService, accountExpiryService, proxyExpiryService, communityBillingService, subscriptionExpiryService, usageCleanupService, idempotencyCleanupService, batchImageCleanupService, batchImageWorkerRuntime, xiaoVideoRuntime, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, subscriptionService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, openAIGatewayService, scheduledTestRunnerService, backupService, paymentOrderExpiryService, channelMonitorRunner, userPlatformQuotaUsageFlusher, upstreamBillingProbeService, ollamaCloudUsageService, auditLogService, promptService)
