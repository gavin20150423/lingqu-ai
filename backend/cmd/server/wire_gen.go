...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	videoObjectStoreFactory := repository.NewS3VideoObjectStoreFactory()
	videoStorageSettingService := service.ProvideVideoStorageSettingService(settingRepository, secretEncryptor, backupService, videoObjectStoreFactory)
