...
type Account struct {
	...
	ShareStatus   string
	SharePolicyID *int64
	// AccountShareModeListingID marks a runtime account selected from a sharing listing.
...
//
// 返回值语义：
//   - nil：未配置 → 调用方应回退到默认值 [401, 403, 429, 502, 503, 504]
...
// supplied default while retaining valid operator-provided relay URLs.
