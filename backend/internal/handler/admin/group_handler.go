...
type CreateGroupRequest struct {
	...
	Platform                 string             `json:"platform" binding:"omitempty,oneof=anthropic openai gemini antigravity grok xiaoapi composite"`
	RateMultiplier           float64            `json:"rate_multiplier"`
	AutoAssignAccountsByRate bool               `json:"auto_assign_accounts_by_rate"`
	AutoAssignMaxRate        *float64           `json:"auto_assign_max_rate"`
...
func (h *GroupHandler) Create(c *gin.Context) {
	...
	group, err := h.adminService.CreateGroup(c.Request.Context(), &service.CreateGroupInput{
		...
		AutoAssignAccountsByRate:        req.AutoAssignAccountsByRate,
		AutoAssignMaxRate:               req.AutoAssignMaxRate,
