...
type Group struct {
	...
	// AutoAssignAccountsByRate holds the value of the "auto_assign_accounts_by_rate" field.
	AutoAssignAccountsByRate bool `json:"auto_assign_accounts_by_rate,omitempty"`
	// AutoAssignMaxRate holds the value of the "auto_assign_max_rate" field.
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldVideoModelPrices, group.FieldModelPricing, group.FieldModelRouting, group.FieldSupportedModelScopes, group.FieldMessagesDispatchModelConfig, group.FieldModelsListConfig, group.FieldCodexModelsManifestConfig, group.FieldReasoningEffortMappings:
			values[i] = new([]byte)
		case group.FieldAutoAssignAccountsByRate, group.FieldPeakRateEnabled, group.FieldIsExclusive, group.FieldAllowImageGeneration, group.FieldAllowBatchImageGeneration, group.FieldImageRateIndependent, group.FieldVideoRateIndependent, group.FieldLongContextPricingEnabled, group.FieldClaudeCodeOnly, group.FieldModelRoutingEnabled, group.FieldMcpXMLInject, group.FieldAllowMessagesDispatch, group.FieldAllowLive, group.FieldForceOpenaiFast, group.FieldFreeOpenaiFast, group.FieldRequireOauthOnly, group.FieldRequirePrivacySet, group.FieldProfitControlEnabled:
			values[i] = new(sql.NullBool)
		case group.FieldRateMultiplier, group.FieldAutoAssignMaxRate, group.FieldPeakRateMultiplier, group.FieldDailyLimitUsd, group.FieldWeeklyLimitUsd, group.FieldMonthlyLimitUsd, group.FieldImageRateMultiplier, group.FieldImagePrice1k, group.FieldImagePrice2k, group.FieldImagePrice4k, group.FieldBatchImageDiscountMultiplier, group.FieldBatchImageHoldMultiplier, group.FieldVideoRateMultiplier, group.FieldVideoPrice480p, group.FieldVideoPrice720p, group.FieldVideoPrice1080p, group.FieldWebSearchPricePerCall, group.FieldSearchPricePer1k, group.FieldAudioRealtimePricePerMin, group.FieldAudioTtsPricePerMillionChars, group.FieldAudioSttPricePerHour, group.FieldProfitMinMargin, group.FieldProfitSafetyBuffer:
	...
	for i := range columns {
		...
		case group.FieldAutoAssignAccountsByRate:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field auto_assign_accounts_by_rate", values[i])
			} else if value.Valid {
				_m.AutoAssignAccountsByRate = value.Bool
			}
		case group.FieldAutoAssignMaxRate:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field auto_assign_max_rate", values[i])
			} else if value.Valid {
				_m.AutoAssignMaxRate = new(float64)
				*_m.AutoAssignMaxRate = value.Float64
			}
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("auto_assign_accounts_by_rate=")
	builder.WriteString(fmt.Sprintf("%v", _m.AutoAssignAccountsByRate))
	builder.WriteString(", ")
	if v := _m.AutoAssignMaxRate; v != nil {
		builder.WriteString("auto_assign_max_rate=")
