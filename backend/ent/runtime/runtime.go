...
func init() {
	...
	// accountgroupDescAutoManaged is the schema descriptor for auto_managed field.
	accountgroupDescAutoManaged := accountgroupFields[4].Descriptor()
	// accountgroup.DefaultAutoManaged holds the default value on creation for the auto_managed field.
	accountgroup.DefaultAutoManaged = accountgroupDescAutoManaged.Default.(bool)
	...
	// groupDescAutoAssignAccountsByRate is the schema descriptor for auto_assign_accounts_by_rate field.
	groupDescAutoAssignAccountsByRate := groupFields[3].Descriptor()
	// group.DefaultAutoAssignAccountsByRate holds the default value on creation for the auto_assign_accounts_by_rate field.
	group.DefaultAutoAssignAccountsByRate = groupDescAutoAssignAccountsByRate.Default.(bool)
	...
	paymentorderDescPromoCode := paymentorderFields[19].Descriptor()
	...
	// promocodeDescDiscountPercent is the schema descriptor for discount_percent field.
	promocodeDescDiscountPercent := promocodeFields[4].Descriptor()
	// promocode.DefaultDiscountPercent holds the default value on creation for the discount_percent field.
	promocode.DefaultDiscountPercent = promocodeDescDiscountPercent.Default.(float64)
	// promocodeDescAppliesToSubscriptions is the schema descriptor for applies_to_subscriptions field.
	promocodeDescAppliesToSubscriptions := promocodeFields[5].Descriptor()
	// promocode.DefaultAppliesToSubscriptions holds the default value on creation for the applies_to_subscriptions field.
	promocode.DefaultAppliesToSubscriptions = promocodeDescAppliesToSubscriptions.Default.(bool)
	// promocodeDescStatus is the schema descriptor for status field.
	promocodeDescStatus := promocodeFields[7].Descriptor()
	...
	promocodeDescUpdatedAt := promocodeFields[11].Descriptor()
	...
	// shoporderDescLoadFactorCreditsAwarded is the schema descriptor for load_factor_credits_awarded field.
	shoporderDescLoadFactorCreditsAwarded := shoporderFields[15].Descriptor()
	// shoporder.DefaultLoadFactorCreditsAwarded holds the default value on creation for the load_factor_credits_awarded field.
	shoporder.DefaultLoadFactorCreditsAwarded = shoporderDescLoadFactorCreditsAwarded.Default.(int)
	...
	// shopproductDescLoadFactorCreditsPerUnit is the schema descriptor for load_factor_credits_per_unit field.
	shopproductDescLoadFactorCreditsPerUnit := shopproductFields[17].Descriptor()
	// shopproduct.DefaultLoadFactorCreditsPerUnit holds the default value on creation for the load_factor_credits_per_unit field.
	shopproduct.DefaultLoadFactorCreditsPerUnit = shopproductDescLoadFactorCreditsPerUnit.Default.(int)
	// shopproductDescDrawMinAmount is the schema descriptor for draw_min_amount field.
	shopproductDescDrawMinAmount := shopproductFields[18].Descriptor()
	...
	shopproductDescDrawMaxAmount := shopproductFields[19].Descriptor()
	...
	shopproductDescDrawGuaranteeCount := shopproductFields[20].Descriptor()
	...
	shopproductDescDrawReturnRate := shopproductFields[21].Descriptor()
	...
	// subscriptionplanDescEntitlements is the schema descriptor for entitlements field.
	subscriptionplanDescEntitlements := subscriptionplanFields[12].Descriptor()
	// subscriptionplan.DefaultEntitlements holds the default value on creation for the entitlements field.
	subscriptionplan.DefaultEntitlements = subscriptionplanDescEntitlements.Default.(func() map[string]interface{})
	...
	userDescPointsBalance := userFields[4].Descriptor()
	...
	// userDescLoadFactorCreditsBalance is the schema descriptor for load_factor_credits_balance field.
	userDescLoadFactorCreditsBalance := userFields[5].Descriptor()
	// user.DefaultLoadFactorCreditsBalance holds the default value on creation for the load_factor_credits_balance field.
	user.DefaultLoadFactorCreditsBalance = userDescLoadFactorCreditsBalance.Default.(int)
	// userDescLoadFactorCreditsUsedTotal is the schema descriptor for load_factor_credits_used_total field.
	userDescLoadFactorCreditsUsedTotal := userFields[6].Descriptor()
	// user.DefaultLoadFactorCreditsUsedTotal holds the default value on creation for the load_factor_credits_used_total field.
	user.DefaultLoadFactorCreditsUsedTotal = userDescLoadFactorCreditsUsedTotal.Default.(int)
	// userDescPreferPointsBilling is the schema descriptor for prefer_points_billing field.
	userDescPreferPointsBilling := userFields[7].Descriptor()
	...
	userDescFrozenBalance := userFields[8].Descriptor()
	...
	usersubscriptionDescDailyUsageUsd := usersubscriptionFields[12].Descriptor()
	...
	usersubscriptionDescWeeklyUsageUsd := usersubscriptionFields[13].Descriptor()
	...
	usersubscriptionDescMonthlyUsageUsd := usersubscriptionFields[14].Descriptor()
	...
	// usersubscriptionDescEntitlements is the schema descriptor for entitlements field.
	usersubscriptionDescEntitlements := usersubscriptionFields[18].Descriptor()
	// usersubscription.DefaultEntitlements holds the default value on creation for the entitlements field.
	usersubscription.DefaultEntitlements = usersubscriptionDescEntitlements.Default.(func() map[string]interface{})
}
