...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/gavin20150423/sub2api:0.1.155-lingqu.1
...
SUB2API_IMAGE=ghcr.io/gavin20150423/sub2api:0.1.155-lingqu.1 # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
